...
$('document').ready(function(){
    ...
    // ====== SETUP LETTER BALLOONS (BISA DIUBAH) =======
    // Ubah tulisan balon di sini:
    var balloonText = ["F","E","L","I","C","I","A","A"];

    // apply ke elemen balon
    for (let i = 1; i <= 8; i++) {
        $("#b" + i + " h2").text(balloonText[i - 1]);
    }
    // ====================================================
